...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Milk } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 relative">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
              <p className="text-sm text-gray-600 mb-2">
                <span className="font-semibold">Admin:</span> admin@milkshop.com / admin123
              </p>
        ...
        <div className="grid grid-cols-3 gap-4 text-center text-xs text-gray-500">
          <div className="p-2">
            <span className="block font-semibold text-gray-700">Secure</span>
            SSL Encrypted
          </div>
          <div className="p-2">
            <span className="block font-semibold text-gray-700">Fast</span>
            Instant Access
          </div>
          <div className="p-2">
            <span className="block font-semibold text-gray-700">24/7</span>
            Support
          </div>
        </div>
      </div>
